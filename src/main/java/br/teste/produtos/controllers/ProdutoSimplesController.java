...
public class ProdutoSimplesController {
    ...
    public ResponseEntity<ProdutoSimplesResponseDTO> cadastrarProdutoSimples(
            @RequestBody @Valid ProdutoSimplesRequestDTO produtoSimplesRequestDTO) throws Exception {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(produtoSimplesService.cadastrar(produtoSimplesRequestDTO));
    }
    ...
    public ResponseEntity<ProdutoSimplesResponseDTO> alteraProdutoSimples(
            @RequestBody @Valid ProdutoSimplesRequestDTO produtoSimplesRequestDTO, @PathVariable Long id) {

...
public class ProdutoDigitalController {
    ...
    public ResponseEntity<ProdutoDigitalResponseDTO> cadastrarProdutoDigital(@RequestBody @Valid ProdutoDigitalRequestDTO produtoDigitalRequestDTO) throws Exception {
        return ResponseEntity.status(HttpStatus.CREATED).body(produtoDigitalService.cadastrar(produtoDigitalRequestDTO));
    }
    ...
    public ResponseEntity<ProdutoDigitalResponseDTO> alteraProdutoDigital(@RequestBody @Valid ProdutoDigitalRequestDTO produtoDigitalRequestDTO, @PathVariable Long id){
